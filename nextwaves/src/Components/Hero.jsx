  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        initial={{opacity: 0, y: 30}}
            ...
            viewport={{once: true}}
             className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Create meaningful connections and turning big ideas into interactive digital experiences.</motion.p>
        ...
        initial={{opacity: 0, scale: 0.9}}
            ...
            <img src={assets.bgImage1} alt='' className='absolute -top-40 -right-40 sm:-top-100 sm:-rigth-70 -z-1 ' />
        </motion.div>
    </div>
  )
}
