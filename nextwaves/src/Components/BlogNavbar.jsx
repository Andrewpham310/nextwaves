    ...
    return (
        <motion.div
            ...
            <Link to="/" className="flex items-center">
                <img src={theme === 'dark' ? assets.logo_dark : assets.logo} className='w-32 sm:w-40' alt='NextWaves' />
            </Link>
            ...
            <div className={`text-gray-700 dark:text-white sm:text-sm ${!sidebarOpen ? 'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10'} max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
                ...
                <Link to="/" onClick={() => setSidebarOpen(false)} className='sm:hover:border-b transition-colors'>Home</Link>
                <a href="/#services" onClick={() => setSidebarOpen(false)} className='sm:hover:border-b transition-colors'>Services</a>
                <a href="/#our-work" onClick={() => setSidebarOpen(false)} className='sm:hover:border-b transition-colors'>Our Work</a>
                <a href="/#testimonial" onClick={() => setSidebarOpen(false)} className='sm:hover:border-b transition-colors'>Testimonial</a>
                <a href="/#blog" onClick={() => setSidebarOpen(false)} className='sm:hover:border-b transition-colors'>Blog</a>
                <a href="/#contact-us" onClick={() => setSidebarOpen(false)} className='sm:hover:border-b transition-colors'>Contact Us</a>
            </div>
